...
![Security Settings](images/dashboard-security-settings.png)
![Security Lists](images/dashboard-security-lists.png)

### ⚡ Selective Approval
Fine-tune automation for file edits, terminal tasks, and Git operations.

![Categories Settings](images/dashboard-categories.png)
...
![AI Quota Tracking](images/dashboard-quota.png)
